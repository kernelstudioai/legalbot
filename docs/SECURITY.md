...
- Transcript persistence and legal-advice generation remain out of scope. Case creation now exists only as an explicit tested application boundary with transactional persistence support and is still not wired into the live OpenWA runtime.
